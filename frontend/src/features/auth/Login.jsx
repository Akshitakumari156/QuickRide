...
const Login = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden px-4">
      <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-slate-900/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-slate-900/5 blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-slate-100 p-8 md:p-10 flex flex-col gap-8 relative z-10 transform transition-all">
        ...
        <form onSubmit={handleBtn} className="flex flex-col gap-5">
          <div className="space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 placeholder-slate-400 font-medium text-sm transition-all duration-200 focus:outline-none focus:border-slate-800 focus:bg-white focus:ring-4 focus:ring-slate-800/10"
              />
            </div>
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            <button
              type="button"
              className="text-xs font-semibold text-slate-900 hover:text-slate-800 transition-colors self-center py-1"
            >
              Forgot password?
            </button>
          </div>
